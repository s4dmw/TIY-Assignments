...
//all that crap above is the starting point...i think
...
//
// // *** need to accoridon any section we click on ***
...
//
//     //this loop will add listeners for a click to all of the <h3> elements
//   for (count = 0; count < liList.length; count ++) {
//     liList[count].addEventListener('click', function(){ // adds event listener for 'click'
//       //console.log("clicky clicky"); // pew pew
//       for(liCounter = 0; liCounter < liList.length; liCounter ++) {
//         //this loop opens/closes each <li> element in the liList
//         //if any <h3> is clicked on -- not exactly what i want but getting closer
//         liList[liCounter].classList.toggle("cbp-ntopen");
//       };
//     });
//   };
//
...
//
  ...
  // *** going make an object of all the headers (h3, h4, h5) with "cbp-nttrigger"
  // class and an object with all the <li> elements then setup a listener for each one
  // that toggles the li's class to open/close the element.
